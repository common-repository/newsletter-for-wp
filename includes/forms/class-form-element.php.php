...
class NL4WP_Form_Element {
	...
	public function get_visible_fields() {
		 ...
		 * @since 2.0
		 */
		$visible_fields = (string) apply_filters( 'nl4wp_form_content', $content, $form );
	...
	public function get_hidden_fields() {
		...
		// hidden fields
		$hidden_fields =  '<div style="display: none;"><input type="text" name="_nl4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></div>';
