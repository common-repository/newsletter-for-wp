		...
		<div class="main-content col col-4">
			...
			<form method="post">
				...
				<div id="titlediv" class="small-margin">
					<div id="titlewrap">
						<label class="screen-reader-text" for="title"><?php _e( 'Enter form title here', 'newsletter-for-wp' ); ?></label>
						<input type="text" name="nl4wp_form[name]" size="30" value="<?php echo esc_attr( $form->name ); ?>" id="title" spellcheck="true" autocomplete="off" placeholder="<?php echo __( "Enter the title of your sign-up form", 'newsletter-for-wp' ); ?>" style="line-height: initial;" >
					</div>
					<div class="inside" style="margin-top: 3px;">

						<input id="shortcode" type="hidden" value="<?php echo esc_attr( sprintf( '[nl4wp_form id="%d"]', $form->ID ) ); ?>">

						<a href="#" class="button-secondary" onclick="prompt('<?php echo esc_attr__( 'Shortcode', 'newsletter-for-wp' ); ?>', document.getElementById('shortcode').value); return false;">
							<span class="dashicons dashicons-editor-code"></span>
							<?php _e( 'Get shortcode', 'newsletter-for-wp' ); ?>
						</a>

						<button type="submit" name="_nl4wp_action" value="preview_form" onblur="this.form.removeAttribute('target');" onfocus="this.form.setAttribute('target','_form_preview');" class="button-secondary" tabindex="-1">
