			...
			<form action="<?php echo admin_url( 'options.php' ); ?>" method="post">
				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td>
							<input type="text" class="widefat" placeholder="<?php _e( 'Your NewsLetter API key', 'newsletter-for-wp' ); ?>" id="newsletter_api_key" name="nl4wp[api_key]" value="<?php echo esc_attr( $opts['api_key'] ); ?>" />
							<p class="help">
